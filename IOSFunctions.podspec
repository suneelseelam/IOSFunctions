...
Pod::Spec.new do |s|
  s.name             = 'IOSFunctions'
  s.version          = '0.1.0'
  s.summary          = 'A short description of IOSFunctions.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Apple/IOSFunctions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Apple' => 'suneelseelam9@gmail.com' }
  s.source           = { :git => 'https://github.com/Apple/IOSFunctions.git', :tag => s.version.to_s }
